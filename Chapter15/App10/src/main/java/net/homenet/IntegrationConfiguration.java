...
public class IntegrationConfiguration {
    ...
    @Bean
    public CustomerSummaryServiceActivator customerSummaryServiceActivator() {
        return new CustomerSummaryServiceActivator();
    }

    @Bean
    public IntegrationFlow deleteCustomer(CustomerDeleteServiceActivator customerDeleteServiceActivator
        , CustomerFilesSplitter filesSplitter
        , CustomerSummaryServiceActivator customerSummaryServiceActivator
        ...
        return IntegrationFlows.from(
            ...
            .split(filesSplitter)
            .handle(customerDeleteServiceActivator)
            .aggregate()
            .handle(customerSummaryServiceActivator)
            .get();
    }
}
