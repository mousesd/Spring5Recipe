...
public class IntegrationConfiguration {
    ...
    @Bean
    public IntegrationFlow jmsInbound(ConnectionFactory connectionFactory, InboundJmsMessageProcessor messageProcessor) {
        return IntegrationFlows
            .from(Jms.messageDrivenChannelAdapter(connectionFactory).extractPayload(true).destination("recipe15-2"))
